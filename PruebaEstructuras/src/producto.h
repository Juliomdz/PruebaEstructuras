...
Producto* producto_newParam(char* nombre,char* apellido,char* dni,int idProducto);
...
int producto_setDescription(Producto* this, char* nombre);
char* producto_getDescription(Producto* this,int* flagError);
int isValidDescription(char* nombre);
int producto_setIdNation(Producto* this, int idProducto);
int producto_getIdNation(Producto* this,int* flagError);
int isValidIdNation(int idProducto);
